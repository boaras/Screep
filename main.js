...
//Declaring Variables
    ...
    var totalPopulation = (harvesters.length + upgraders.length + builders.length) + 0;
    var maxPopulation = 15;
    var harvesterPopulationCap = .5;
    var upgraderPopulationCap = .25;
    var builderPopulationCap = .25;
